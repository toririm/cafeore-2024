...
const resources = [
  {
    ...
    icon: (
      ...
      >
        <title>
          Remix icon representing a lightning bolt, symbolizing a quick start
        </title>
        <path
  ...
  },
  {
    ...
    icon: (
      <svg
        ...
        className="stroke-gray-600 group-hover:stroke-current dark:stroke-gray-300"
      >
        <title>Remix icon representing a book, symbolizing a tutorial</title>
        <path
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <title>
          Remix icon representing a book, symbolizing the Remix documentation
        </title>
        <path
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <title>
          Remix icon representing a chat bubble, symbolizing the Remix Discord
          community
        </title>
        <path
